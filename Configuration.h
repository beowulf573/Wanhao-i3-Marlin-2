...
#define STRING_CONFIG_H_AUTHOR "Keith Bailey" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Wanhao i3" // will be shown during bootup in line 1
//#define STRING_SPLASH_LINE2 MKS SBASE K200          // will be shown during bootup in line 2
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 35 // If the temperature difference between the target temperature and the actual temperature
...
// #define DELTA
  ...
  #define DELTA_HEIGHT 262.87 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 110.17 //mm  Get this value from auto calibrate
...
#define DEFAULT_ZJERK                 1.0  // Must be same as XY for delta
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define PROBE_PT_1_X 25       // Probing points for 3-Point leveling of the mesh
  #define PROBE_PT_1_Y 25
  #define PROBE_PT_2_X 150
  #define PROBE_PT_2_Y 120
