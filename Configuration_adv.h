...
#define DIGIPOT_I2C_MOTOR_CURRENTS { 0.95, 0.95, 0.95, 0.8, 0.95 }  //  MKS SBASE: 5
...
// #define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_Z_ADD 1                 // Z addition of hotend (lift)
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 50   // Unload filament length from hotend in mm
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_5 "Probe Bed"
  #define USER_GCODE_5 "G30"
#endif
